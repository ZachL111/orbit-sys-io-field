"""Regression checks for the orbit-sys-io-field casebook."""
...
from casebook.harness import assert_expected, orbit_sys_io_field_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(orbit_sys_io_field_summary(), assert_expected())
